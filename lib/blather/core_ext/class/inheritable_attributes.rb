...
class Class # :nodoc:
  ...
  def inheritable_attributes
    @inheritable_attributes ||= BLATHER_EMPTY_INHERITABLE_ATTRIBUTES
  end

  def write_inheritable_attribute(key, value)
    if inheritable_attributes.equal?(BLATHER_EMPTY_INHERITABLE_ATTRIBUTES)
  ...
  private
    ...
    BLATHER_EMPTY_INHERITABLE_ATTRIBUTES = {}.freeze

    def inherited_with_inheritable_attributes(child)
      inherited_without_inheritable_attributes(child) if respond_to?(:inherited_without_inheritable_attributes)

      if inheritable_attributes.equal?(BLATHER_EMPTY_INHERITABLE_ATTRIBUTES)
        new_inheritable_attributes = BLATHER_EMPTY_INHERITABLE_ATTRIBUTES
      else
